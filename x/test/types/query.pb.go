...
func init() {
	...
	proto.RegisterType((*QuerySayHelloRequest)(nil), "test.test.QuerySayHelloRequest")
	proto.RegisterType((*QuerySayHelloResponse)(nil), "test.test.QuerySayHelloResponse")
}
...
var fileDescriptor_8913136649ec41e5 = []byte{
	...
	,
}
...
func (c *queryClient) SayHello(ctx context.Context, in *QuerySayHelloRequest, opts ...grpc.CallOption) (*QuerySayHelloResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/test.test.Query/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/test.test.Query/SayHello",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
